...
class Stemmer {
    ...
    /**constructor initializes the buffer, length and offset.*/
    public Stemmer() {
        b = new char[INC];
        i = 0;
        end = 0;
     ...
     * @return the stemming result
     */
    public String toString() { return new String(b,0,end); }

    /**
     * Returns the length of the word resulting from the stemming process.
     * @return the length of result
     */
    public int getResultLength() { return end; }
